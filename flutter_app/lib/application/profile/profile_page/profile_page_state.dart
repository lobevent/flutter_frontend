...
class ProfilePageState with _$ProfilePageState {
  ...
  factory ProfilePageState.loadingMeta() =  ProfileLoadMetaInProgress;
  factory ProfilePageState.loaded({required Profile profile, List<Profile>? friends}) = _ProfilePageLoaded;
