...
class EventRemoteService{
  ...
  Future<EventDto> createEvent(EventDto eventDto) async {
    return _decodeEvent( await client.post(postPath, jsonEncode(eventDto.toJson())));
  }
  ...
  Future<EventDto> deleteEvent(EventDto eventDto) async {
    ...
    await client.delete("$deletePath${eventDto.id}"); // TODO this way the toString function will be called automatically
