...
class _EppGridListTileState extends State<EppGridListTile> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    ImageProvider image = Image
        .network(dotenv.env['ipSim']!.toString() + widget.epp.path)
        .image;
    ...
    return Opacity(
      ...
      child: MaterialButton(
        ...
        onPressed: ()
        {
          ...
          GenDialog.genericDialog(context, AppStrings.genericDeleteTitle, AppStrings.genericDeleteDialogText).then((value) {
