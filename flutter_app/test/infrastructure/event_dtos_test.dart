...
main() {
  ...
  EventDto origTestDto = EventDto.withoutId(
      name: "EVENT1",
      public: true,
  ...
  group('CRUD', () {
    ...
    test("Post with 200 response", () async {
      ...
      when(client.post("ourUrl.com/event",  headers: authenticationHeader, body: jsonEncode(origTestDto.toJson()))).thenAnswer((realInvocation) async => http.Response(jsonEncode(TestDtoWithId.toJson()), 200));
