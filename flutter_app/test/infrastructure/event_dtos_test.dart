...
main() {
  ...
  group('CRUD', () {
    ...
    test("get List Test", () async {
      final listOptions = {Operation.attending:EventRemoteService.attendingEventsPath, Operation.fromUser:EventRemoteService.profileEventPath, Operation.owned:EventRemoteService.ownedEventsPath, Operation.unreacted:EventRemoteService.unreactedEventsPath };


      listOptions.forEach((operation, path) async{
